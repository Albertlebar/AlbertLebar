                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                ...
                                                <div class="button-group">
                                                    ...
                                                    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#quick_view"><span data-bs-toggle="tooltip" data-bs-placement="left" title="Quick View"><i class="pe-7s-search"></i></span></a>
                                                </div>
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="javascript:void(0);">
                                                    ...
                                                    <img class="sec-img" src="{{ asset('assets/img/product/product-17.jpg') }}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>sale</span>
                                            ...
                                            <div class="product-caption text-center">
                                                <div class="product-identity">
                                                    <p class="manufacturer-name"><a href="javascript:void(0);">mony</a></p>
                                                </div>
                                                <ul class="color-categories">
                                                    <li>
                                                        <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                                ...
                                                <h6 class="product-name">
                                                    <a href="javascript:void(0);">Handmade Golden Necklace</a>
                                                </h6>
                                                <div class="price-box">
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="javascript:void(0);">
                                                    ...
                                                    <img class="sec-img" src="{{ asset('assets/img/product/product-16.jpg') }}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>new</span>
                                            ...
                                            <div class="product-caption text-center">
                                                <div class="product-identity">
                                                    <p class="manufacturer-name"><a href="javascript:void(0);">Diamond</a></p>
                                                </div>
                                                <ul class="color-categories">
                                                    <li>
                                                        <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="javascript:void(0);">
                                                    ...
                                                    <img class="sec-img" src="{{ asset('assets/img/product/product-15.jpg') }}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>sale</span>
                                            ...
                                            <div class="product-caption text-center">
                                                <div class="product-identity">
                                                    <p class="manufacturer-name"><a href="javascript:void(0);">silver</a></p>
                                                </div>
                                                <ul class="color-categories">
                                                    <li>
                                                        <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                                ...
                                                <h6 class="product-name">
                                                    <a href="javascript:void(0);">Diamond Exclusive Ornament</a>
                                                </h6>
                                                <div class="price-box">
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="javascript:void(0);">
                                                    ...
                                                    <img class="sec-img" src="{{ asset('assets/img/product/product-14.jpg')}}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>new</span>
                                            ...
                                            <div class="product-caption text-center">
                                                ...
                                                <h6 class="product-name">
                                                    <a href="javascript:void(0);">Citygold Exclusive Ring</a>
                                                </h6>
                                                <div class="price-box">
                                                    <span class="price-regular">$60.00</span>
                                                    <span class="price-old"><del>$70.00</del></span>
                                ...
                                <div class="tab-pane fade" id="tab2">
                                    <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="javascript:void(0);">
                                                    <img class="pri-img" src="{{ asset('assets/img/product/product-7.jpg') }}" alt="product">
                                                    <img class="sec-img" src="{{ asset('assets/img/product/product-12.jpg')}}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>sale</span>
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="javascript:void(0);">
                                                    <img class="pri-img" src="{{ asset('assets/img/product/product-8.jpg') }}" alt="product">
                                                    <img class="sec-img" src="{{asset('assets/img/product/product-11.jpg')}}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>new</span>
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="javascript:void(0);">
                                                    <img class="pri-img" src="{{asset('assets/img/product/product-9.jpg')}}" alt="product">
                                                    <img class="sec-img" src="{{asset('assets/img/product/product-10.jpg')}}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>sale</span>
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="javascript:void(0);">
                                                    <img class="pri-img" src="{{asset('assets/img/product/product-10.jpg')}}" alt="product">
                                                    <img class="sec-img" src="{{ asset('assets/img/product/product-9.jpg') }}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>new</span>
                                ...
                                <div class="tab-pane fade" id="tab3">
                                    <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="javascript:void(0);">
                                                    <img class="pri-img" src="{{ asset('assets/img/product/product-11.jpg') }}" alt="product">
                                                    <img class="sec-img" src="{{ asset('assets/img/product/product-8.jpg') }}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>new</span>
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="javascript:void(0);">
                                                    <img class="pri-img" src="{{ asset('assets/img/product/product-12.jpg')}}" alt="product">
                                                    <img class="sec-img" src="{{ asset('assets/img/product/product-7.jpg')}}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>sale</span>
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="javascript:void(0);">
                                                    <img class="pri-img" src="{{ asset('assets/img/product/product-13.jpg') }}" alt="product">
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="javascript:void(0);">
                                                    <img class="pri-img" src="{{ asset('assets/img/product/product-14.jpg') }}" alt="product">
                                                    <img class="sec-img" src="{{ asset('assets/img/product/product-5.jpg') }}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>sale</span>
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="javascript:void(0);">
                                                    <img class="pri-img" src="{{ asset('assets/img/product/product-15.jpg') }}" alt="product">
                                                    <img class="sec-img" src="{{ asset('assets/img/product/product-4.jpg') }}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>new</span>
                                ...
                                <div class="tab-pane fade" id="tab4">
                                    <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="javascript:void(0);">
                                                    <img class="pri-img" src="{{ asset('assets/img/product/product-16.jpg') }}" alt="product">
                                                    <img class="sec-img" src="{{ asset('assets/img/product/product-3.jpg')}}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>new</span>
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="javascript:void(0);">
                                                    <img class="pri-img" src="{{ asset('assets/img/product/product-17.jpg') }}" alt="product">
                                                    <img class="sec-img" src="{{ asset('assets/img/product/product-2.jpg') }}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>sale</span>
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="javascript:void(0);">
                                                    <img class="pri-img" src="{{ asset('assets/img/product/product-18.jpg')}}" alt="product">
                                                    <img class="sec-img" src="{{ asset('assets/img/product/product-1.jpg') }}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
                                                        <span>new</span>
                        ...
                        <div class="product-banner-carousel slick-row-10">
                            ...
                            <div class="banner-slide-item">
                                <figure class="banner-statistics">
                                    <a href="#">
                                        <img src="{{ asset('assets/img/banner/img1-middle.jpg') }}" alt="product banner">
                                    </a>
                            ...
                            <div class="banner-slide-item">
                                <figure class="banner-statistics">
                                    <a href="#">
                                        <img src="{{ asset('assets/img/banner/img2-middle.jpg') }}" alt="product banner">
                                    </a>
                                    <div class="banner-content banner-content_style2">
                            ...
                            <div class="banner-slide-item">
                                <figure class="banner-statistics">
                                    <a href="#">
                                        <img src="{{ asset('assets/img/banner/img3-middle.jpg') }}" alt="product banner">
                                    </a>
                                    <div class="banner-content banner-content_style2">
                            ...
                            <div class="banner-slide-item">
                                <figure class="banner-statistics">
                                    <a href="#">
                                        <img src="{{ asset('assets/img/banner/img4-middle.jpg') }}" alt="product banner">
                                    </a>
                                    <div class="banner-content banner-content_style2">
                            ...
                            <div class="banner-slide-item">
                                <figure class="banner-statistics">
                                    <a href="#">
                                        <img src="{{ asset('assets/img/banner/img5-middle.jpg') }}" alt="product banner">
                                    </a>
                                    <div class="banner-content banner-content_style2">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="group-product-banner">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="{{ asset('assets/img/banner/img-bottom-banner.jpg') }}" alt="product banner">
                                </a>
                                ...
                                <div class="group-list-carousel">
                                    ...
                                    <div class="group-slide-item">
                                        <div class="group-item">
                                            <div class="group-item-thumb">
                                                <a href="javascript:void(0);">
                                                    <img src="{{ asset('assets/img/product/product-13.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="group-item-desc">
                                                <h5 class="group-product-name"><a href="javascript:void(0);">
                                    ...
                                    <div class="group-slide-item">
                                        <div class="group-item">
                                            <div class="group-item-thumb">
                                                <a href="javascript:void(0);">
                                                    <img src="{{ asset('assets/img/product/product-15.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="group-item-desc">
                                                <h5 class="group-product-name"><a href="javascript:void(0);">
                                ...
                                <div class="group-list-carousel">
                                    ...
                                    <div class="group-slide-item">
                                        <div class="group-item">
                                            <div class="group-item-thumb">
                                                <a href="javascript:void(0);">
                                                    <img src="{{ asset('assets/img/product/product-17.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="group-item-desc">
                                                <h5 class="group-product-name"><a href="javascript:void(0);">
                                    ...
                                    <div class="group-slide-item">
                                        <div class="group-item">
                                            <div class="group-item-thumb">
                                                <a href="javascript:void(0);">
                                                    <img src="{{ asset('assets/img/product/product-16.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="group-item-desc">
                                                <h5 class="group-product-name"><a href="javascript:void(0);">
                                    ...
                                    <div class="group-slide-item">
                                        <div class="group-item">
                                            <div class="group-item-thumb">
                                                <a href="javascript:void(0);">
                                                    <img src="{{ asset('assets/img/product/product-12.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="group-item-desc">
                                                <h5 class="group-product-name"><a href="javascript:void(0);">
                                    ...
                                    <div class="group-slide-item">
                                        <div class="group-item">
                                            <div class="group-item-thumb">
                                                <a href="javascript:void(0);">
                                                    <img src="{{ asset('assets/img/product/product-18.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="group-item-desc">
                                                <h5 class="group-product-name"><a href="javascript:void(0);">
                                    ...
                                    <div class="group-slide-item">
                                        <div class="group-item">
                                            <div class="group-item-thumb">
                                                <a href="javascript:void(0);">
                                                    <img src="{{ asset('assets/img/product/product-14.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="group-item-desc">
                                                <h5 class="group-product-name"><a href="javascript:void(0);">
