                ...
                <div class="card-body">
                    <ul class="nav nav-tabs mb-3" id="ex1" role="tablist">
                      <li class="nav-item" role="presentation">
                        <a class="nav-link active" id="link-tab-product-details" data-mdb-toggle="tab" href-div="tab-product-details" role="tab" aria-controls="ex1-tabs-1" aria-selected="true" >Invoice Details</a>
                      </li>
                    </ul>
                    <!-- Tabs content -->
                        ...
                        <div class="d-flex">
                            <div class="col-md-6 col-sm-12">
                                <div class="d-flex mt-1">
                                    ...
                                    <div class="col-md-9">
                                       {!! Form::select('user_id', $users ?? [],  $invoice->user_id ?? '', ['class' => 'form-control select2','data-control'=>"select2", 'id'=>'customer', 'disabled'=>'true']) !!}
                                    </div>
                                </div>
                                <div class="d-flex mt-1">
                                    <input type="hidden" name="user_type" value="{{ App\Models\User::find($invoice->user_id)->user_type }}" id="user_type">
                                    <div class="col-md-3">
                                        <p><strong> Shipping First Name : </strong></p>
                                    </div>
                                    <div class="col-md-9">
                                       <p id="shipping_address_first_name">{{ $invoice->shipping_address_first_name }}</p>
                                    </div>
                                </div>
                                <div class="d-flex mt-1">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                       <p id="shipping_address_last_name">
                                           {{ $invoice->shipping_address_last_name }}
                                       </p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12" style="border-left: 1px solid #f195ab;">
                                <div class="d-flex mt-1">
                                    ...
                                    <div class="col-md-9">
                                        <p  id="shipping_address_1">{{ $invoice->shipping_address_1 }}</p>
                                    </div>
                                </div>
                                <div class="d-flex mt-1">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                        <p id="shipping_address_2">{{ $invoice->shipping_address_2 }}</p>
                                    </div>
                                </div>
                                <div class="d-flex mt-1">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                        <p  id="shipping_city">{{ $invoice->shipping_city }}</p>
                                    </div>
                                </div>
                                <div class="d-flex mt-1">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                        <p id="shipping_postcode">{{ $invoice->shipping_postcode }}</p>
                                    </div>
                                </div>
                                <div class="d-flex mt-1">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                        <p id="shipping_country">{{ $invoice->shipping_country }}</p>
                                    </div>
                                </div>
                                <div class="d-flex mt-1">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                        <p id="shipping_contact">{{ $invoice->shipping_contact }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>             
                    ...
                    <div class="table-responsive mt-3">
                        <table id="manage_all_item"
                            ...
                            <tbody id="product-item">
                                @foreach($invoice->orderItem as $row)
                                    @include('backend.admin.order.order_item',compact('action','row','invoice'))
                                @endforeach
                            </tbody>
                            <tr style="background: #f195ab;">
                                <td colspan="6" class="text-right"><strong>Sub Total</strong></td>
                                <td>
                                    <input type="hidden" name="i_sub_total" value="{{ $invoice->sub_total }}" id="i_sub_total">
                                    <strong><p id="p_sub_total">&pound; {{number_format((float)$invoice->sub_total, 2, '.', '')}}</p></strong>
                                </td>
                                <td></td>
                            </tr
>                            <tr style="background: #f195ab;">
                                ...
                                <td><input type="checkbox" class="add_vat" name="add_vat" <?php echo $checked ?>></td>
                                <td></td>
                            </tr>
                            <tr style="background: #f195ab;">
                                <td colspan="6" class="text-right"><strong>Total</strong></td>
                                <td>
                                    <input type="hidden" name="i_total" value="{{ $invoice->order_total }}" id="i_total">
                                    <strong><p id="p_total">&pound; {{ number_format((float)$invoice->order_total, 2, '.', '') }}</p></strong>
                                </td>
                                <td></td>
                            </tr>
                        </table>
    ...
    $(document).ready(function () {
        ...
        $('#edit').validate({// <- attach '.validate()' to your form
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                        url: '{{ url("admin/invoice") }}'+'/'+'{{ $invoice->id }}',
                        type: 'POST',
                        data: myData,
                        dataType: 'json',
                        cache: false,
