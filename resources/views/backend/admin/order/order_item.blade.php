...
<tr id="item_{{ $row->id }}">
  ...
  <td>
    ...
    <td style="width: 150px">
      ...
      @endif
      <input type="number" name="old_total_item_price[{{ $row->id }}]" id="total_item_price_{{ $row->id }}" class="form-control total_item_price" value="{{ number_format((float)$row->price, 2, '.', '') }}">
...
<tr id="item_{{ $item->id }}">
  <td>{{ $rowCount }}</td>
    ...
    <td style="width: 150px;">
      ...
      @endif
      <input type="number" name="total_item_price[{{ $item->id }}]" id="total_item_price_{{ $item->id }}" class="form-control total_item_price" value="">
